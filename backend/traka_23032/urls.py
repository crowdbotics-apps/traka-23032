...
admin.site.site_header = "Traka"
admin.site.site_title = "Traka Admin Portal"
admin.site.index_title = "Traka Admin"

# swagger
api_info = openapi.Info(
    title="Traka API",
    default_version="v1",
    description="API documentation for Traka App",
)
